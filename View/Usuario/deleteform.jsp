                            ...
                            <form action="addusuario.jsp" method="post">
                                <div class="col-md-12">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" disabled="disabled" class="form-control" name="nome" required value="<%=u.getNome()%>">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="email">Informe e-mail:</label>
                                        <input type="email" disabled="disabled" class="form-control" name="email" required value="<%=u.getEmail()%>">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="email">Informe login:</label>
                                        <input type="text"  disabled="disabled" class="form-control" name="login" required value="<%=u.getLogin()%>">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="email">Informe senha:</label>
                                        <input type="password" disabled="disabled" class="form-control" name="senha" requiredvalue="<%=u.getSenha()%>">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="perfil">Informe Perfil:</label>
                                        <select class="form-control" disabled="disabled" id="sel1" name="perfil" required>
                                ...
                                <div class="form-group col-md-12">
                                    <div class="col-md-4">
                                      ...
                                      <button id="deletar" name="dele" class="btn btn-primary">Deletar</button>
                                    </div>
                                </div>    
                            </form>
                        </div>
